 ...
 * @version 0.2
 */
public class InfoMBeanImpl implements InfoMBean {

	private static Logger logger = LogManager.getLogger(InfoMBeanImpl.class.getName());
	 ...
	 */
	public InfoMBeanImpl(Config config) {
		this.config = config;
		...
		OpenMBeanAttributeInfoSupport[] attributes = new OpenMBeanAttributeInfoSupport[] {
				new OpenMBeanAttributeInfoSupport(ATTR_INFO, "Handlers statistics", pageTabularType, true, false,
						false) };
		PSOMBInfo = new OpenMBeanInfoSupport(InfoMBean.class.getName(), "Handler Statistics OMB", attributes,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.dsf.dbxtract.cdc.mon.InfoMBean#getAttribute(java.lang.String)
	 */
		...
		if (attrName.equals(ATTR_INFO)) {
			try {
				...
				for (StatEntry entry : list) {
					Object[] itemValues = { entry.getName(), entry.getLastSeek(), entry.getLastRead(),
							entry.getReadCount() };
					try {
				...
				logger.error("getAttribute('" + attrName + "')", e);
			}
		}
		return null;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.dsf.dbxtract.cdc.mon.InfoMBean#setAttribute(javax.management.
	 * Attribute)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.dsf.dbxtract.cdc.mon.InfoMBean#getAttributes(java.lang.String[])
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.dsf.dbxtract.cdc.mon.InfoMBean#setAttributes(javax.management.
	 * AttributeList)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.dsf.dbxtract.cdc.mon.InfoMBean#invoke(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.dsf.dbxtract.cdc.mon.InfoMBean#getMBeanInfo()
	 */
	@Override
